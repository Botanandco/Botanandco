...
function sendMail() {
	...
	if (params.from_name !== '' && params.email_id !== '') {
		emailjs
...
const btnFormCheck = document.querySelector('.form-check-label');
...
btnFormCheck.addEventListener('click', () => {
	footer.classList.add('show-popup');
});
...
const sectionObesrver = new IntersectionObserver(observeSection, { root: null, threshold: 0.8 });
